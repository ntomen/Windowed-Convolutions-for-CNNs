...
from resnet7x7 import resnet18_7x7
...
def save_checkpoint(state, is_best, filename='checkpoint_7x7_rn18.pth.tar'):
    bulk_dir='save_dir'
    torch.save(state, os.path.join(bulk_dir,filename))
    if is_best:
        shutil.copyfile(os.path.join(bulk_dir,filename), os.path.join(bulk_dir,'model_best_7x7_rn18.pth.tar'))
