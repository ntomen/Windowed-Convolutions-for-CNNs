...
def save_checkpoint(state, is_best, filename='checkpoint_vgg11_bn.pth.tar'):
    bulk_dir='save_dir'
    torch.save(state, os.path.join(bulk_dir,filename))
    if is_best:
        shutil.copyfile(os.path.join(bulk_dir,filename), os.path.join(bulk_dir,'model_best_vgg11_bn.pth.tar'))
