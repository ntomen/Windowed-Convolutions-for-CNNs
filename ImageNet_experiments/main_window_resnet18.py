...
from windowed_resnet import resnet18_window
...
def save_checkpoint(state, is_best, filename='checkpoint_window.pth.tar'):
    torch.save(state, filename)
    if is_best:
        shutil.copyfile(filename, 'model_best_window.pth.tar')
