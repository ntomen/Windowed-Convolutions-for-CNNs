...
class Conv2d_window(_ConvNd):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1,
                 ...
                 bias=True, padding_mode='zeros', window_fn='hamming'):
        ...
        if window_fn not in ['hamming','blackman']:
            raise ValueError('only windowing with hamming and blackman are supported.')
        else:
    ...
    def conv2d_forward(self, input, weight):
        if self.window_fn=='hamming':
            ...
            weight=window_with_blackman(weight)
